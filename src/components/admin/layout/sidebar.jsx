    ...
    <>
          <aside id="layout-menu" className="layout-menu menu-vertical menu bg-menu-theme">
            ...
            {sidebarLinks?.map((links, index) => (
              <ul className="menu-inner py-1" key={index}>
                {/* Dashboards */}
                <li
                ...
                >
                  <a className="menu-link menu-toggle">
                    <links.icon size={20} className="menu-icon" />
                    <div data-i18n="Dashboards">{links.title}</div>
                  ...
                  {
                    <ul
                      className="menu-sub open"
                      style={{ display: isOpen ? "block" : "none" }}
                    >
                      {links.children.map((child, idx) => (
                        <li key={idx} className="menu-item">
                          <a href={child.path} className="menu-link">
                            <div data-i18n="eCommerce">{child.title}</div>
                          </a>
                        </li>
                      ))}
                    </ul>
